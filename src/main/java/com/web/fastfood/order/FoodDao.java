...
public class FoodDao {
    ...
    public int getMainFoodsPrice(String name){
        return DB.mainFoods.entrySet().stream().filter(e -> e.getKey().equals(name))
                .findFirst()
                .get()
                .getValue();
    }
    public int getSecondFoodsPrice(String name){
        return DB.secondFoods.entrySet().stream().filter(e -> e.getKey().equals(name))
                .findFirst()
                .get()
                .getValue();
    }
    ...
    public int getdrinksPrice(String name){
        return DB.drinks.entrySet().stream().filter(e -> e.getKey().equals(name))
                .findFirst()
                .get()
                .getValue();
    }
